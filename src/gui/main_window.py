"""
Main application window for Nimar PDF Converter
"""
...
class MainWindow(QMainWindow):
    ...
    def remove_selected_file(self):
        ...
        if selected_items:
            try:
                # Loop through selected items and remove them from the list
            ...
            print("No files selected to remove.")
    ...
    def _perform_individual_conversion(
        self, output_dir: str, filename_base: str, overwrite_all: bool
    ):
        ...
        try:
            ...
            if failed_files:
                QMessageBox.warning(
                    self,
                    "Conversion Complete with Issues",
        ...
        try:
            ...
            for i, file_path in enumerate(files):
                if file_path.lower().endswith(".pdf"):
                    ...
                    success, pdf_path = self.converter.convert_to_pdf(
    ...
    def show_about(self):
        ...
        QMessageBox.about(
            self,
            "About Nimar PDF Converter",
            "Nimar PDF Converter v1.0 | Author Danish Khan, JSO\n\n"
    ...
    def _check_converter_status(self):
        ...
        if not status["libreoffice"]:
            self.status_bar.showMessage(
                "Warning: LibreOffice not available - Office document conversion disabled"
            )
        else:
